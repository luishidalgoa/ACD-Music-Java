...
public class AlbumCardController {
    ...
    public void setData(Album album) {
        ...
        this.artist_name.setText(ArtistDAO.getInstance().searchArtistByIdArtist(album.getIdAlbum()).getName());
                    ...
                    menuItem.setOnAction(e -> {
                        try {
                            if (rl.getSongs()!=null){
                                ...
                                ReproductionListDAO.getInstance().addSong(album.getIdAlbum(), rl.getId());
